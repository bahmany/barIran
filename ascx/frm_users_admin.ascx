<%@ Control Language="C#" AutoEventWireup="true" CodeFile="frm_users_admin.ascx.cs" Inherits="ascx_frm_UsersAdmin" %>
<%@ Register src="frm_registration_form.ascx" tagname="frm_RegistrationForm" tagprefix="uc1" %>
